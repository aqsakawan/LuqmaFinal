        ...
        regButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validate()) {
                    ...
                    String user_email = userEmail.getText().toString().trim(); //changed email to name
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(user_email, user_password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(activity_reg.this, "Successfully Registered, Upload complete!", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(activity_reg.this, SecondActivity.class));
                            } else {
                                Toast.makeText(activity_reg.this, "Registration Failed" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                            }
